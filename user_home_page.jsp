...
<nav class="navbar navbar-inverse">
  <div class="container">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="profile.jsp" style="color: white">UPES</a>
    </div>
...
<div class="jumbotron">
  ...
  <p class="text-center"><a class="btn btn-primary btn-lg" href="user_profile.jsp" role="button">Learn more by creating your profile page!</a></p><br><br>
